...
def geneticAlgorithmSolver(population, fitnessFunction):
    ...
    for _ in range(len(population)):
        ...
        print(f"Offspring before Mutation: {offspring}")
        if random.random() < mutationProbability:
            offspring = applyMutation(offspring)
            print(f"Offspring after Mutation: {offspring}")
...
def startSolver():
    ...
    try:
        ...
        print(f"Initial Population (Generation 0): {initialPopulation}")
        generationCounter = 1
        ...
        def solve():
            ...
            print(f"\nGeneration {generationCounter} Fitness Values: {fitnessValues}")
            ...
            if maxFitness in fitnessValues:
                ...
                print(f"Solution Found in Generation {generationCounter}: {solution}")
            ...
            print(f"Best Chromosome in Generation {generationCounter}: {bestChromosome}")
            ...
            print(f"New Population (Generation {generationCounter}): {initialPopulation}")

            # Display the best chromosome on the chessboard
